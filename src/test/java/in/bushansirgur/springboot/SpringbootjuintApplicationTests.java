...
class SpringbootjuintApplicationTests {
	 ...
	 * 
	 * @Order(3) 
	 * public void testRead () { Product product =
	 * pRepo.findById(1L).get(); assertEquals("iPhone XR", product.getName()); }
	 */
	  @Test
	 
	  @Order(4)
	  public void testUpdate () { Product p = pRepo.findById(1L).get();
	  p.setPrice(900.00); pRepo.save(p); assertNotEquals(800.00,
	 ...
	 * 
	 * @Order(5) 
	 * public void testDelete () { pRepo.deleteById(1L);
